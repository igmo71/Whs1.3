...
namespace Whs.Server.Controllers
{
    ...
    [ApiController]
    public class WhsOrderOuts_Controller : ControllerBase
    {
        private readonly ApplicationDbContext _context;

        public WhsOrderOuts_Controller(ApplicationDbContext context)
        {
            _context = context;
        }

        // GET: api/WhsOrderOuts_
        [HttpGet]
