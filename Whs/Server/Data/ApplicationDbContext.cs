...
namespace Whs.Server.Data
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<ProductIn>().ToTable(name: "WhsProductsIn");
            ...
            builder.Entity<ProductDataIn>().ToTable(name: "WhsProductsDataIn");
            ...
            builder.Entity<MngrOrderIn>().ToTable("WhsMngrOrdersIn");
            ...
            builder.Entity<ProductOut>().ToTable(name: "WhsProductsOut");
            ...
            builder.Entity<ProductDataOut>().ToTable(name: "WhsProductsDataOut");
            ...
            builder.Entity<MngrOrderOut>().ToTable("WhsMngrOrdersOut");
